...
The application features are still under development. The core handicap calculation domain logic, backend profile creation endpoint, two-tier backend course ratings lookup, course and tee persistence, and transactional round logging with scorecard capping and automatic handicap recalculation are implemented; the frontend profile, course-search, and scorecard-entry flows, round history, and Vercel deployment have not yet been implemented.
