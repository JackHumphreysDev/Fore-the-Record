...
Accepted friends can now form private player groups with live leaderboards for verified round activity, Stableford points, 18-hole gross scoring, and Handicap Index improvement. Each group includes a private message board for general discussion or comments attached to a recent group round, while notes and full scorecard details remain outside the group.
